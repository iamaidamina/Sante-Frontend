...
const data = {
  ...
  'g-recaptcha-response': recaptchaValue
    ...
    try {
      const response = await fetch('sante-backend-production-a693.up.railway.app/api/users/register', {
        method: 'POST',
        headers: {
...
const styles = {
  ...
  // Cada grupo de input ocupa la mitad
  inputGroupHalf: {
    flex: '1',
    display: 'flex',
    flexDirection: 'column',
  ...
  checkbox: {
    ...
    height: '18px',
    cursor: 'pointer',
    accentColor: '#088395', // Color que combina con tu degradado
  },
  checkboxLabel: {
    fontSize: '13px',
    color: '#334155',
